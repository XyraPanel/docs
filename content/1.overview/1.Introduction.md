...
description: Meet the core team, helpers, and roadmap.
icon: i-lucide-users
to: /overview/about
---
::
...
---
title: FAQ
description: Answers to the common pre-launch questions.
...
description: Spin up the panel locally with the CLI.
icon: i-lucide-terminal
to: /setup/installation/development-mode
---
::
...
description: Keep releases, hosting, and ops funded.
icon: i-lucide-crown
to: /community/sponsor-the-project
---
::
:::